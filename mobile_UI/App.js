...
function ScreenCopyScreen({ colors, connectedComputers }) {
  const activeDevice = connectedComputers[0];
  ...
  return (
    <ScrollView style={styles.transferScroll} contentContainerStyle={styles.transferContent} showsVerticalScrollIndicator={false}>
      ...
      {activeDevice ? (
        <>
          <View style={[styles.settingCard, { backgroundColor: colors.card, borderColor: colors.line, shadowColor: colors.shadow }]}>
            <Text style={[styles.sectionTitle, { color: colors.text }]}>Screen Copy</Text>
            <View style={styles.copyPreviewWrap}>
              <View style={[styles.copyPreview, { backgroundColor: colors.panel, borderColor: colors.line }]}>
                <MonitorIcon color={colors.blue} />
                <Text style={[styles.copyPreviewTitle, { color: colors.text }]}>{activeDevice.name}</Text>
                <Text style={[styles.copyPreviewMeta, { color: colors.subtle }]}>Ready to mirror screen</Text>
              </View>
            </View>
            <View style={styles.identityGrid}>
              <SmallField colors={colors} label="Resolution" value="1080p" />
              <SmallField colors={colors} label="Status" value="Online" online />
            </View>
          </View>

          <View style={[styles.transferActionCard, { backgroundColor: colors.card, borderColor: colors.line, shadowColor: colors.shadow }]}>
            <Pressable style={[styles.transferAction, { backgroundColor: colors.blue }]}>
              <MonitorIcon color="#ffffff" small />
              <Text style={styles.transferActionText}>Start Copy</Text>
            </Pressable>
            <Pressable style={[styles.transferAction, { backgroundColor: colors.blueSoft }]}>
              <StopIcon color={colors.blue} />
              <Text style={[styles.transferActionText, { color: colors.blue }]}>Stop</Text>
            </Pressable>
          </View>
        </>
      ) : (
        <View style={[styles.emptyStateCard, { backgroundColor: colors.card, borderColor: colors.line, shadowColor: colors.shadow }]}>
          ...
          <Text style={[styles.emptyTitle, { color: colors.text }]}>No computer connected</Text>
          <Text style={[styles.emptyCopy, { color: colors.subtle }]}>Connect a computer from Home to start screen copy</Text>
        </View>
      )}
    </ScrollView>
  );
...
function SettingsScreen({ colors, theme, setTheme, settings, setSettings, device, onRenameDevice }) {
  ...
  return (
    <ScrollView style={styles.transferScroll} contentContainerStyle={styles.transferContent} showsVerticalScrollIndicator={false}>
      ...
      <View style={[styles.settingCard, { backgroundColor: colors.card, borderColor: colors.line, shadowColor: colors.shadow }]}>
        <Text style={[styles.sectionTitle, { color: colors.text }]}>Stream Performance</Text>
  ...
  return (
    ...
    >
      <View style={[styles.sliderTrack, { backgroundColor: colors.panel }]}>
        ...
        <View style={[styles.sliderThumb, { left: `${normalizedValue * 100}%`, backgroundColor: colors.blue }]} />
      </View>
    </View>
  );
}
...
function BottomNav({ colors, activeScreen, setActiveScreen }) {
  return (
    <View style={[styles.bottomNav, { backgroundColor: colors.nav, borderTopColor: colors.line }]}>
      ...
      <NavItem colors={colors} active={activeScreen === "copy"} label="Screen Copy" onPress={() => setActiveScreen("copy")}>
        <MonitorIcon color={activeScreen === "copy" ? colors.blue : colors.faint} />
      </NavItem>
  ...
  return (
    <SafeAreaView style={[styles.safeArea, { backgroundColor: colors.bg }]}>
      ...
      <View style={[styles.appFrame, { width: Math.min(width, 390), backgroundColor: colors.bg }]}>
        ...
        {activeScreen === "copy" && <ScreenCopyScreen colors={colors} connectedComputers={connectedComputers} />}
...
function ProfileIcon({ color }) {
  return (
    <Svg width={19} height={19} viewBox="0 0 24 24">
      <Circle {...iconStroke} cx={12} cy={8} r={3.25} stroke={color} strokeWidth={1.7} />
      <Path {...iconStroke} d="M6.75 20c.65-3.05 2.55-4.58 5.25-4.58S16.6 16.95 17.25 20" stroke={color} strokeWidth={1.7} />
    </Svg>
  );
}
  ...
  return (
    <Svg width={large ? 44 : 38} height={large ? 64 : 56} viewBox="0 0 40 58">
      <Rect
        ...
        strokeWidth={2.8}
      />
      <Path {...iconStroke} d={large ? "M15 47.5h10" : "M16 48h8"} stroke={color} strokeWidth={2.8} />
    </Svg>
  );
}
...
function LaptopIcon({ color, large }) {
  return (
    <Svg width={large ? 52 : 48} height={large ? 50 : 46} viewBox="0 0 46 42">
      <Rect {...iconStroke} x={9} y={5} width={28} height={22} rx={2.5} stroke={color} strokeWidth={2.8} />
      <Path {...iconStroke} d="M5 35h36l-4.5-8h-27zM19 32h8" stroke={color} strokeWidth={2.8} />
...
function WifiIcon({ dimmed }) {
  return (
    <Svg width={55} height={45} viewBox="0 0 52 42" opacity={dimmed ? 0.35 : 1}>
      <Path {...iconStroke} d="M7 16.8c11-9.4 27.9-9.4 39 0" stroke="#12bde8" strokeWidth={7} />
      <Path {...iconStroke} d="M16.2 25.5c5.8-5 13.8-5 19.6 0" stroke="#1478f8" strokeWidth={7} />
...
function ChevronIcon({ color }) {
  return (
    <Svg width={18} height={18} viewBox="0 0 24 24">
      <Path {...iconStroke} d="M9 6l6 6-6 6" stroke={color} strokeWidth={2} />
    </Svg>
  );
}
...
function HomeIcon({ color }) {
  return (
    <Svg width={23} height={23} viewBox="0 0 24 24">
      <Path {...iconStroke} d="M4 10.7L12 4l8 6.7M6.5 10.2V20h15v-9.8M10 20v-5h4v5" stroke={color} strokeWidth={1.75} />
    </Svg>
  );
}
...
function MonitorIcon({ color, small }) {
  return (
    <Svg width={small ? 18 : 23} height={small ? 18 : 23} viewBox="0 0 24 24">
      <Rect {...iconStroke} x={4} y={5} width={16} height={12} rx={1.5} stroke={color} strokeWidth={1.75} />
      <Path {...iconStroke} d="M9 21h6M12 17v4" stroke={color} strokeWidth={1.75} />
    </Svg>
  );
}
...
function GearIcon({ color }) {
  return (
    <Svg width={23} height={23} viewBox="0 0 24 24">
      <Circle {...iconStroke} cx={12} cy={12} r={3} stroke={color} strokeWidth={1.75} />
      <Path
        {...iconStroke}
...
function EditIcon({ color }) {
  return (
    <Svg width={16} height={16} viewBox="0 0 24 24">
      <Path {...iconStroke} d="M16.85 4.55l2.6 2.6M5 19l4.15-.82L18.65 8.7l-3.35-3.35-9.48 9.5z" stroke={color} strokeWidth={2} />
    </Svg>
  );
}
...
function DownIcon({ color }) {
  return (
    <Svg width={14} height={14} viewBox="0 0 24 24">
      <Path {...iconStroke} d="M6 9l6 6 6-6" stroke={color} strokeWidth={2} />
    </Svg>
  );
}
...
function VolumeIcon({ color, muted }) {
  return (
    <Svg width={21} height={21} viewBox="0 0 24 24">
      <Path {...iconStroke} d="M4 9v6h4l5 4V5L8 9z" stroke={color} strokeWidth={1.8} />
      {muted ? (
        <Path {...iconStroke} d="M16 9l5 6M21 9l-5 6" stroke={color} strokeWidth={1.8} />
      ) : (
        <Path {...iconStroke} d="M16 8.2a5 5 0 0 1 0 7.6" stroke={color} strokeWidth={1.8} />
      )}
    </Svg>
  );
}
...
function SendIcon({ color, small }) {
  return (
    <Svg width={small ? 17 : 20} height={small ? 17 : 20} viewBox="0 0 24 24">
      <Path {...iconStroke} d="M4 12h13M12 7l5 5-5 5M5 5h14v14H5z" stroke={color} strokeWidth={1.8} />
    </Svg>
  );
}
...
function ReceiveIcon({ color, small }) {
  return (
    <Svg width={small ? 17 : 20} height={small ? 17 : 20} viewBox="0 0 24 24">
      <Path {...iconStroke} d="M20 12H7M12 7l-5 5 5 5M5 5h14v14H5z" stroke={color} strokeWidth={1.8} />
    </Svg>
  );
}
...
function StopIcon({ color }) {
  return (
    <Svg width={20} height={20} viewBox="0 0 24 24">
      <Rect {...iconStroke} x={6} y={6} width={12} height={12} rx={2.5} stroke={color} strokeWidth={1.8} />
    </Svg>
  );
}
...
function SunIcon({ color }) {
  return (
    <Svg width={15} height={15} viewBox="0 0 24 24">
      <Circle {...iconStroke} cx={12} cy={12} r={3.5} stroke={color} strokeWidth={1.7} />
      <Path
        {...iconStroke}
...
function MoonIcon({ color }) {
  return (
    <Svg width={15} height={15} viewBox="0 0 24 24">
      <Path {...iconStroke} d="M19.5 15.1A7.7 7.7 0 0 1 8.9 4.5 8 8 0 1 0 19.5 15.1z" stroke={color} strokeWidth={1.7} />
    </Svg>
  );
}
